---
title: "Mortal Shell II Beta Progress: What Resets and What You Keep"
description: "No. Open Beta saves don't transfer — story progress, items, Shells and currency reset. Only The Flayed Harbinger cosmetic and an optional Prologue skip carry."
category: game-info
slug: mortal-shell-ii/beta-progress-carry-over
status: confirmed
featured: true
quickAnswer: "No. Open Beta save data does NOT transfer to the full game — story progress, levels, inventory, weapons, Shells, currency, collectibles and other Beta items reset at launch. The only documented launch entitlements are The Flayed Harbinger cosmetic (Steam: reported unlock after >30 minutes of Beta play) and an optional Prologue skip for qualifying Beta players (PlayStation: progress beyond Marrow Keep)."
faq:
  ...
  - question: "What from the Beta does carry over into the full game?"
    answer: "Only the documented Beta-player benefits: The Flayed Harbinger cosmetic and an optional Prologue skip. These are launch entitlements, not a restored save."
  - question: "How do I unlock The Flayed Harbinger?"
    answer: "A Steam developer reply says playing the Open Beta for more than 30 minutes automatically unlocks the Flayed Harbinger; the PlayStation listing also advertises the cosmetic as an Open Beta bonus. The numeric time threshold is not verified for consoles in the checked sources."
  - question: "How do I qualify to skip the Prologue in the full game?"
    answer: "Official PlayStation copy says players who progress beyond Marrow Keep in the Open Beta unlock the option to skip the Prologue in the full game. The Steam developer reply also confirms a qualifying Beta player can skip the Prologue."
  - question: "Will my Beta weapons, currency, Shells or collectibles carry forward?"
    answer: "No. The PlayStation Open Beta listing explicitly says currency, weapons, Shells, collectibles and other items discovered during the Open Beta reset at launch."
related:
...
2. Optional Prologue skip
   ...
   - Boundary: the skip is an option presented in the full game; menu labels and exact behavior are not published in the checked first-party sources. See our dedicated guidance at [mortal-shell-ii/skip-prologue/](/mortal-shell-ii/skip-prologue/) for the decision and confirmed trophy consequences.
...
- If you are deciding whether to use the Prologue skip in the full game, see [mortal-shell-ii/skip-prologue/](/mortal-shell-ii/skip-prologue/) for the eligibility, consequences, and trophy confirmation.

## Related pages

- Open Beta overview: [mortal-shell-ii/open-beta/](/mortal-shell-ii/open-beta/)
- Skip Prologue details and decision: [mortal-shell-ii/skip-prologue/](/mortal-shell-ii/skip-prologue/)
- Prevent confusion with New Game Plus: [mortal-shell-ii/new-game-plus/](/mortal-shell-ii/new-game-plus/)
- Launch context (past event): [mortal-shell-ii/release-date/](/mortal-shell-ii/release-date/)
- If you need a progression boundary reference for late-game systems (separate from Beta): [mortal-shell-ii/ova/](/mortal-shell-ii/ova/)
