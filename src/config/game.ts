		...
		recentUpdates: [
				{
					...
					href: '/mortal-shell-ii/hall-of-illusions/',
					date: '2026-08-23',
					changeSummary: 'Perspective doorways, hidden wall, Vrannic clones, and the Glutted Mire route.',
					tag: 'Exploration',
				},
				{
					title: 'Lucian',
					href: '/mortal-shell-ii/lucian-thirsting-knight/',
					date: '2026-08-23',
					changeSummary: 'Hidden Keep route, higher-ground transition, and the invisible phase at Stonebled Gate.',
					tag: 'Boss',
				},
				{
					title: 'Forgotten Crossbow',
					href: '/mortal-shell-ii/forgotten-crossbow/',
					date: '2026-08-23',
					changeSummary: 'Flooded Village route, Damp Key landmark, and return path to the locked Sidearm room.',
					tag: 'Weapon',
				},
				{
					title: 'Cursed Child',
					href: '/mortal-shell-ii/cursed-child/',
					date: '2026-08-23',
					changeSummary: 'Revered Beacon route, golden-light cover traversal, and the upper light-source puzzle.',
					tag: 'Weapon',
				},
		],
		fieldNoteOrder: [
