...
export const game: GameConfig = {
	...
	portal: {
		...
		guideTopicGroups: [
			...
			},
			{
				...
				guideOrder: [
					...
					'/mortal-shell-ii/prisoners-domain/',
					'/mortal-shell-ii/conquered-temple/',
					'/mortal-shell-ii/revered-beacon/',
					'/mortal-shell-ii/withered-shoals/',
					'/mortal-shell-ii/faded-citadel/',
					'/mortal-shell-ii/hushed-sanctum/',
		...
		guideVisuals: {
			...
			'/mortal-shell-ii/revered-beacon/': { icon: 'map' },
			...
			'/mortal-shell-ii/lazlo/': { icon: 'shell' },
		...
		popularQuestions: [
			{ label: 'Where are Blackmarrow Keys and Shade chests?', href: '/mortal-shell-ii/blackmarrow-keys/' },
			{ label: 'Game bug or stuck? Start at Known Issues', href: '/mortal-shell-ii/known-issues/' },
	...
	routes: [
		...
		},
		{
			...
			pages: [
				...
				{
					pageId: 'lazlo',
					href: '/mortal-shell-ii/lazlo/',
					title: 'Lazlo',
					description: 'Reach the Royal Crypt, unlock Lazlo, and build around Heat, Overheat, and armor breaks.',
					eyebrow: 'Shell Unlock',
				},
				{
					pageId: 'unfound-path',
					href: '/mortal-shell-ii/unfound-path/',
					title: 'Unfound Path Walkthrough',
					description: 'Open the Unfound Path, clear its three branch guardians, and reach the Zmey endgame handoff.',
					eyebrow: 'Walkthrough',
				},
				{
					pageId: 'glutted-mire',
					href: '/mortal-shell-ii/glutted-mire/',
					title: 'Glutted Mire Walkthrough',
					description: 'Follow the Glutted Mire route, cleanse its corruption, and connect the Fainweald landmarks.',
					eyebrow: 'Walkthrough',
				},
				{
					pageId: 'sanguine-caverns',
					href: '/mortal-shell-ii/sanguine-caverns/',
					title: 'Sanguine Caverns Walkthrough',
					description: 'Reach Pulsing Caves and Sanguine Shoreline, cleanse the Lost Child route, and return for the key follow-up.',
					eyebrow: 'Walkthrough',
				},
				{
					pageId: 'prisoners-domain',
					href: '/mortal-shell-ii/prisoners-domain/',
					title: "Prisoner's Domain Walkthrough",
					description: "Activate the Prisoner's Domain Beacons, route through Captive's End, and prepare the Nameless Captive gate.",
					eyebrow: 'Walkthrough',
				},
				{
					pageId: 'conquered-temple',
					href: '/mortal-shell-ii/conquered-temple/',
					title: 'Conquered Temple Walkthrough',
					description: 'Reach Ovate’s Chamber and the Conquered Temple route before Droeg’s Mammon gate.',
					eyebrow: 'Walkthrough',
				},
				{
					pageId: 'revered-beacon',
					href: '/mortal-shell-ii/revered-beacon/',
					title: 'Revered Beacon Walkthrough',
					description: 'Route from Sester’s Gate, survive the golden light, and clear the dungeon for Cursed Child.',
					eyebrow: 'Walkthrough',
				},
				{
					pageId: 'withered-shoals',
					href: '/mortal-shell-ii/withered-shoals/',
					title: 'Withered Shoals Walkthrough',
					description: 'Follow the Withered Shoals route from Nameless Pass toward the Hexapod gate.',
					eyebrow: 'Walkthrough',
				},
				{
					pageId: 'faded-citadel',
					href: '/mortal-shell-ii/faded-citadel/',
					title: 'Faded Citadel Walkthrough',
					description: 'Route through the Faded Citadel and Ashen Sanctum before Isaac’s encounter.',
					eyebrow: 'Walkthrough',
				},
				{
					pageId: 'proxima',
