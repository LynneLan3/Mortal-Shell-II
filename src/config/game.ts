		...
		recentUpdates: [
			{
				...
				href: '/mortal-shell-ii/tiel/',
				date: '2026-08-23',
				changeSummary: "Widow's Overlook route, torch-marked grave, and Rash Memory unlock.",
				tag: 'Shells',
			},
			{
				title: "Veteran's Battle Axe",
				href: '/mortal-shell-ii/veterans-battle-axe/',
				date: '2026-08-23',
				changeSummary: "King's Crypt entrance, traps, and final weapon pickup.",
				tag: 'Weapon',
			},
			{
				title: 'Black Needle',
				href: '/mortal-shell-ii/black-needle/',
				date: '2026-08-23',
				changeSummary: "Sester's Bastion bells, raised walkways, and weapon route.",
				tag: 'Weapon',
			},
			{
				title: 'Obsidian Hammer',
				href: '/mortal-shell-ii/obsidian-hammer/',
				date: '2026-08-23',
				changeSummary: 'Obsidianite Mines route and Prophet of Profane Infinities encounter.',
				tag: 'Weapon',
			},
			{
				title: 'Endings Guide',
