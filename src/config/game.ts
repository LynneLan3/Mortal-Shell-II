	...
	portal: {
		...
		hotGuides: [
			...
			},
			{
				...
				description: 'Use the easier Slayer Seal only if you accept the save-wide achievement lock, or choose Night Mode for the harder route.',
				href: '/mortal-shell-ii/slayer-seal-difficulty/',
				label: 'Priority 04',
				badge: 'Confirmed',
			},
			{
				title: 'Hall of Illusions',
				description: 'Solve the perspective doorways, break the hidden wall, identify the real Vrannic, and open Glutted Mire.',
				href: '/mortal-shell-ii/hall-of-illusions/',
				label: 'Priority 05',
				badge: 'Exploration',
			},
			{
				title: 'Sidearms Guide',
				description: 'Find all eight launch Sidearms with compact route pointers and detailed guides for Forgotten Crossbow, Cursed Child, and Caged Hystrix.',
		...
		recentUpdates: [
				...
				},
				{
					...
					href: '/mortal-shell-ii/lost-child/',
					date: '2026-08-23',
					changeSummary: 'Sanguine Caverns route, grab and ranged attacks, positioning, and post-boss progression.',
					tag: 'Boss',
				},
				{
					title: 'Blackmarrow Keys',
					href: '/mortal-shell-ii/blackmarrow-keys/',
					date: '2026-08-23',
					changeSummary: 'Eight keys, eight Shade chests, five confirmed routes, and three intentionally unconfirmed.',
					tag: 'Exploration',
				},
				{
					title: 'Slayer Seal & Difficulty',
					href: '/mortal-shell-ii/slayer-seal-difficulty/',
					date: '2026-08-23',
					changeSummary: 'The official save-wide achievement lock, easier Slayer combat, and reversible Night Mode.',
					tag: 'Confirmed',
				},
		],
		fieldNoteOrder: [
